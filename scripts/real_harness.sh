...
run_mcp_checks() {
  ...
  assert_json '([.result.tools[].name] | index("find_files") and index("search_content") and index("search_path_and_content") and index("memo_check"))' "${LOG_DIR}/mcp-tools-list.json"
